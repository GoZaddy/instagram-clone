...
//                        ((NavigationBarItemView)bottomNavigationView.findViewById(R.id.action_home)).(R.);
//                        ((MenuItem)bottomNavigationView.findViewById(R.id.action_profile)).setIcon(R.drawable.ic_baseline_person_outline_24);
